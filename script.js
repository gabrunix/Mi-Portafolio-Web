const translations = {
    es: {
        ...
        edu_degree: "<span style='color: var(--primary); font-size: 1.15em;'>Desarrollo de Software</span> <span style='font-size: 0.85em; color: var(--text-light); font-weight: normal;'>(Estudios Superiores)</span>",
        edu_certs_title: "Certificaciones y Especializaciones:",
        edu_desc: "Bases de datos, Python, JavaScript, Docker, Git, Taller de Ciberseguridad, Business Intelligence with Power BI, Ingeniería de Prompts e Inteligencia Artificial.",
    ...
    en: {
        ...
        edu_degree: "<span style='color: var(--primary); font-size: 1.15em;'>Software Development</span> <span style='font-size: 0.85em; color: var(--text-light); font-weight: normal;'>(Higher Education)</span>",
        edu_certs_title: "Certifications & Additional Courses:",
        edu_desc: "Databases, Python, JavaScript, Docker, Git, Cybersecurity Workshop, Business Intelligence with Power BI, Prompt Engineering, and Artificial Intelligence.",
